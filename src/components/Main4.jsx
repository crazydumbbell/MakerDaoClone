const Main4 = () => {
  return (
    <div className="bg-gray-50 mx-[500px] mt-[100px] mb-[200px]">
      <div className="flex flex-col justify-center items-center mx-[220px] py-14 gap-5 text-aliyn:center">
        <span className="text-2xl font-bold">Join the community</span>
      ...
      <div className="flex justify-center items-center gap-32 mb-20 ">
        ...
        <div className="p-2 flex flex-col justify-center items-center">
          <img className="h-6" src="./images/25231.png" />
          <span className="text-black">GitHub</span>
        </div>
      </div>
      <div className="flex justify-center  w-full pb-64 ">
        <div className="text-xl font-bold">Recent blog posts</div>
      </div>
      <div className="flex justify-center items-center gap-7 mt-10 relative">
        <div className="flex flex-col h-[366px] w-[266px] border rounded-lg absolute -translate-y-20 -translate-x-[350px] ">
          <img className="h-[254px] w-[298px] " src="./images/11.jpg" />
          <span className="px-6 py-3">MakerDAO Has Come Full Circle</span>
          <span className="px-6 pb-3 text-gray-300">July 20, 2021</span>
        </div>
        <div className="flex flex-col h-[366px] w-[266px] border rounded-lg absolute -translate-y-20">
          <img className="h-[254px] w-[298px]" src="./images/22.jpg" />
          <span className="px-6 py-3">
            Why the MakerDAO Forum is the Heart of the Maker
          </span>
          <span className="px-6 pb-3 text-gray-300">April 22, 2021</span>
        </div>
        <div className="flex flex-col h-[366px] w-[266px] border rounded-lg absolute -translate-y-20 translate-x-[350px]">
          <img className="h-[254px] w-[298px]" src="./images/33.jpg" />
          <span className="px-6 py-3">
            A Brief History of Decentralized Finance (Defi)
          </span>
          <span className="px-6 pb-3 text-gray-300">March 12, 2021</span>
        </div>
      </div>
    </div>
  );
